...
const DICT = {
	en: {
		...
		'play.clone': '＋ Clone', 'play.move': '↗ Move',
		...
		'result.rematch': 'Rematch', 'result.harder': 'Harder ↑', 'result.easier': 'Easier ↓', 'result.tryAgain': 'Try Again', 'result.select': 'Stage Select',
	...
	ko: {
		...
		'result.rematch': '재대결', 'result.harder': '난이도 ↑ 도전', 'result.easier': '난이도 ↓', 'result.tryAgain': '다시 도전', 'result.select': '스테이지 선택',
