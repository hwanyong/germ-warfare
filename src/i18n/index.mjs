...
const DICT = {
	en: {
		...
		'title.tip3': 'Works offline too!', 'title.tip4': 'Land next to a foe to infect it!',
		...
		'title.tip9': 'Settings: send your progress via QR!', 'title.tip10': 'Replay the tutorial anytime from the button above!',
		...
		'settings.language': 'Language', 'settings.credits': 'Credits', 'settings.back': 'Back', 'settings.coming': 'soon',
		...
		'settings.reset': 'Reset Account', 'settings.resetConfirm': 'This permanently deletes all stage progress, best scores, and tutorial status on this device. Language stays as-is. This cannot be undone. Continue?',
		'settings.resetConfirmOk': 'Delete', 'settings.resetConfirmCancel': 'Cancel',
	...
	ko: {
		...
		'title.tip3': '오프라인에서도 플레이 가능!', 'title.tip4': '적 옆에 놓으면 감염!',
		'title.tip5': '최대 4팀 난전도 가능!', 'title.tip6': '로컬 대전에서 맵 크기 직접 설정!',
		'title.tip7': '스테이지별 최고점 기록!', 'title.tip8': '이겼으면 난이도 ↑ 도전!',
		'title.tip9': '설정에서 QR로 진행상황 전송!', 'title.tip10': '튜토리얼은 위 버튼으로 언제든 다시보기!',
		...
		'settings.language': '언어', 'settings.credits': '크레딧', 'settings.back': '뒤로', 'settings.coming': '준비중',
		...
		'settings.reset': '계정 초기화', 'settings.resetConfirm': '이 기기의 모든 스테이지 진행기록, 최고점, 튜토리얼 완료 상태가 영구 삭제됩니다. 언어 설정은 유지됩니다. 되돌릴 수 없습니다. 계속할까요?',
		'settings.resetConfirmOk': '삭제', 'settings.resetConfirmCancel': '취소',
